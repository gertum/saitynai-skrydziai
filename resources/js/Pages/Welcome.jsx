                        ...
                        <>
                            ...
                            <div
                                ...
                                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                                    <div className="flex justify-center custom-margins">
                                        <svg
                                            viewBox="0 0 62 65"
                                            fill="none"
                                    ...
                                    <div className="p-4 sm:p-8 bg-gray-200 mx-auto shadow sm:rounded-lg custom-margins text-center">
                                        ...
                                        <p className="mb-4">
                                            ...
                                            <input className="custom-margins shadow sm:rounded-lg"type="search" placeholder="Search..." />
